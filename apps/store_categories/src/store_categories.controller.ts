...
export class StoreCategoriesController {
    ...
    @Put(':id')
    async update(@Param('id') id: ValidObjectIdDTO, @Body() store_category: Store_categories): Promise<Store_categories> {
      return await this.storeCategoriesService.update(id, store_category);
    }
